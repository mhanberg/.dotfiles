...
if vim.g.thicc_forest.italics then
  italics = "italic"
else
  italics = nil
end
...
vim.g.terminal_color_5 = terminal_colors.purple
vim.g.terminal_color_6 = terminal_colors.cyan
vim.g.terminal_color_7 = terminal_colors.white
vim.g.terminal_color_8 = terminal_colors.black
vim.g.terminal_color_9 = terminal_colors.red
vim.g.terminal_color_10 = terminal_colors.green
vim.g.terminal_color_11 = terminal_colors.yellow
vim.g.terminal_color_12 = terminal_colors.blue
vim.g.terminal_color_13 = terminal_colors.purple
vim.g.terminal_color_14 = terminal_colors.cyan
vim.g.terminal_color_15 = terminal_colors.white
